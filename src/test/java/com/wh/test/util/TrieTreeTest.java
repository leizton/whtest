...
public class TrieTreeTest {
  ...
  public void test() {
    ...
    Assert.assertEquals("ab2", tree.nodeToStr(n4));
    ...
    Assert.assertEquals("ac1", tree.nodeToStr(n5));
